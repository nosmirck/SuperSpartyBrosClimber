...
public class CharacterController2D : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            DoJump();
        } else if (_canDoubleJump && Input.GetButtonDown("Jump")) //if grounded and jump pressed then it allow double jump
        {
            DoJump();
            // disable double jump after double jumping so you can do it once
